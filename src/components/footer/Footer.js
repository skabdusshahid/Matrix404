                        ...
                        <div className="row justify-content-lg-between">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="footer_widget pe-md-3">
                                    ...
                                    <p>
                                        Sign up to Matrix404 weekly newsletter to get the latest updates.
                                    </p>
                                    ...
                                    <ul className="social_links_block unordered_list">
                                        <li><a href="https://www.facebook.com/profile.php?id=61564720868843" target="_blank" rel="noopener noreferrer">Facebook</a></li>
            ...
            <div className="footer_bottom">
                <div className="container d-md-flex align-items-md-center justify-content-md-between">
                    <p className="copyright_text m-0">
                        Copyright © 2024 Matrix404, All rights reserved.
                    </p>
                    <p className="copyright_text m-0">
                        Developed by <Link onClick={ClickHandler} to="/">AS & JS</Link>
                    </p>
                </div>
            </div>
        </footer>
